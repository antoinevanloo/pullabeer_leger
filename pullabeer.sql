...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 20 Octobre 2017 à 15:10
...
CREATE TABLE IF NOT EXISTS `compose` (
  ...
  PRIMARY KEY (`comp_ll`,`comp_mus`),
  KEY `fk_comp_mus` (`comp_mus`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `informe` (
  ...
  PRIMARY KEY (`inf_eve`,`inf_uti`),
  KEY `fk_inf_uti` (`inf_uti`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `musique` (
  ...
  PRIMARY KEY (`mus_id`),
  KEY `fk_mus_arti` (`mus_arti`),
  KEY `fk_mus_genre` (`mus_genre`),
  KEY `fk_mus_val` (`mus_val`)
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  PRIMARY KEY (`uti_id`),
  KEY `fk_uti_perm` (`uti_perm`),
  KEY `fk_uti_civ` (`uti_civ`)
...
(9, 'Van Loo', 'Antoine', 'antoine@gmail.com', '9cf95dacd226dcf43da376cdb6cbba7035218921', '1996-12-27', '30 rue franÃ§ois couperin', '', '00000', 'Plaisir', '1', 3, 1),
